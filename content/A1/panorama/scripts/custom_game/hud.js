...
const temporaryPanelHost = (_a = dotaHud.FindChild('__react_panorama_temporary_host__')) !== null && _a !== void 0 ? _a : $.CreatePanel('Panel', dotaHud, '__react_panorama_temporary_host__');
...
var D__dev_dota__modules_reactPanorama_node_modules_objectAssign = shouldUseNative() ? Object.assign : function (target, source) {
	var from;
	var to = toObject(target);
	var symbols;
...
var D__dev_dota__modules_reactPanorama_node_modules_scheduler = createCommonjsModule(function (module) {
...
var _assign = D__dev_dota__modules_reactPanorama_node_modules_objectAssign;
var React = react__WEBPACK_IMPORTED_MODULE_0__;
var checkPropTypes = checkPropTypes_1;
var Scheduler = D__dev_dota__modules_reactPanorama_node_modules_scheduler;
...
const propertiesInformation = {
    ...
    enabled: { type: 0 /* SET */, name: 'enabled', initial: true, throwOnIncomplete: true },
    visible: { type: 0 /* SET */, name: 'visible', initial: true, throwOnIncomplete: true },
        ...
        update(panel, newValue) {
            ...
            if (newValue) {
                ...
                if (!status) {
                    ...
                    throw new Error(`Cannot create children for "dangerouslyCreateChildren":\n${indentedLayout}`);
                }
            }
        },
    },
...
definePanelPropertyInformation('Label', Object.assign(Object.assign({}, labelTextAttributes), { allowtextselection: { type: 2 /* INITIAL_ONLY */, initial: true } }));
...
definePanelPropertyInformation('DOTAHeroImage', Object.assign(Object.assign({}, imageAttributes), { heroid: { type: 0 /* SET */, name: 'heroid', initial: true }, heroname: { type: 0 /* SET */, name: 'heroname', initial: true }, heroimagestyle: { type: 0 /* SET */, name: 'heroimagestyle', initial: true }, usedefaultimage: { type: 2 /* INITIAL_ONLY */, initial: true } }));
definePanelPropertyInformation('DOTACountryFlagImage', Object.assign(Object.assign({}, imageAttributes), { country_code: { type: 2 /* INITIAL_ONLY */, initial: true } }));
...
definePanelPropertyInformation('EconItemImage', Object.assign(Object.assign({}, imageAttributes), { itemdef: { type: 2 /* INITIAL_ONLY */, initial: true } }));
const animatedImageStripAttributes = Object.assign(Object.assign({}, imageAttributes), { frametime: { type: 2 /* INITIAL_ONLY */, initial: true }, defaultframe: { type: 2 /* INITIAL_ONLY */, initial: true }, animating: { type: 2 /* INITIAL_ONLY */, initial: true } });
...
definePanelPropertyInformation('DOTAHeroMovie', {
    ...
    persona: { type: 0 /* SET */, name: 'persona' },
    autoplay: { type: 2 /* INITIAL_ONLY */, initial: true },
});
...
definePanelPropertyInformation('ToggleButton', Object.assign(Object.assign({}, labelTextAttributes), { selected: { type: 0 /* SET */, name: 'checked' }, html: { type: 2 /* INITIAL_ONLY */, initial: true } }));
...
definePanelPropertyInformation('Carousel', {
    ...
    selectionposboundary: { type: 2 /* INITIAL_ONLY */, initial: true },
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BLESSING_CHANNEL_SECONDS: () => (/* binding */ BLESSING_CHANNEL_SECONDS),
/* harmony export */   BUSH_FADEOUT_SECONDS: () => (/* binding */ BUSH_FADEOUT_SECONDS),
/* harmony export */   DUO_KILL_TARGET: () => (/* binding */ DUO_KILL_TARGET),
/* harmony export */   EVENT_NAMES: () => (/* binding */ EVENT_NAMES),
/* harmony export */   FAST_RESPAWN_SECONDS: () => (/* binding */ FAST_RESPAWN_SECONDS),
/* harmony export */   FFA_KILL_TARGET: () => (/* binding */ FFA_KILL_TARGET),
/* harmony export */   GAME_LENGTH_SECONDS: () => (/* binding */ GAME_LENGTH_SECONDS),
/* harmony export */   MAP_ENTITY_PREFIX: () => (/* binding */ MAP_ENTITY_PREFIX),
/* harmony export */   NET_TABLES: () => (/* binding */ NET_TABLES),
/* harmony export */   TELEPORT_COOLDOWN_SECONDS: () => (/* binding */ TELEPORT_COOLDOWN_SECONDS)
/* harmony export */ });
const GAME_LENGTH_SECONDS = 8 * 60;
const FFA_KILL_TARGET = 15;
const DUO_KILL_TARGET = 20;
const FAST_RESPAWN_SECONDS = 2;
const BLESSING_CHANNEL_SECONDS = 2;
const TELEPORT_COOLDOWN_SECONDS = 6;
const BUSH_FADEOUT_SECONDS = 0.5;
const NET_TABLES = {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HERO_DEFINITIONS: () => (/* binding */ HERO_DEFINITIONS)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BLESSING_IDS: () => (/* binding */ BLESSING_IDS),
/* harmony export */   GAME_PHASES: () => (/* binding */ GAME_PHASES),
/* harmony export */   HERO_IDS: () => (/* binding */ HERO_IDS),
/* harmony export */   PROJECTILE_TYPES: () => (/* binding */ PROJECTILE_TYPES),
/* harmony export */   RUNE_IDS: () => (/* binding */ RUNE_IDS)
/* harmony export */ });
const HERO_IDS = ["windrunner", "sniper"];
const PROJECTILE_TYPES = ["instant_line", "charged_line"];
const BLESSING_IDS = ["none", "shield", "multishot", "swiftness"];
const RUNE_IDS = ["none", "haste", "ambush", "frenzy"];
const GAME_PHASES = ["warmup", "pregame", "in_progress", "post_game"];


/***/ },

/***/ "./src/panorama/utils/hero_data.ts"
/*!*****************************************!*\
  !*** ./src/panorama/utils/hero_data.ts ***!
  \*****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   HERO_DEFINITIONS: () => (/* reexport safe */ _shared_hero_data__WEBPACK_IMPORTED_MODULE_0__.HERO_DEFINITIONS)
/* harmony export */ });
/* harmony import */ var _shared_hero_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @shared/hero_data */ "./shared/hero_data.ts");



/***/ },

/***/ "./src/panorama/utils/net.ts"
/*!***********************************!*\
  !*** ./src/panorama/utils/net.ts ***!
  \***********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getLocalPlayerId: () => (/* binding */ getLocalPlayerId),
/* harmony export */   getMatchSnapshot: () => (/* binding */ getMatchSnapshot),
/* harmony export */   getPlayerState: () => (/* binding */ getPlayerState),
/* harmony export */   getScoreboardEntries: () => (/* binding */ getScoreboardEntries),
/* harmony export */   interactPickup: () => (/* binding */ interactPickup),
...
function getPlayerState(playerId) {
    const value = CustomNetTables.GetTableValue(_shared_config__WEBPACK_IMPORTED_MODULE_0__.NET_TABLES.playerState, `${playerId}`);
    return value === null ? undefined : value;
}
function getScoreboardEntries() {
    const raw = CustomNetTables.GetTableValue(_shared_config__WEBPACK_IMPORTED_MODULE_0__.NET_TABLES.matchState, "scoreboard");
    if (!raw) {
        return [];
    }
...
function getMatchSnapshot() {
    const value = CustomNetTables.GetTableValue(_shared_config__WEBPACK_IMPORTED_MODULE_0__.NET_TABLES.matchState, "snapshot");
    return value === null ? undefined : value;
}
function selectHero(heroId) {
    GameEvents.SendCustomGameEventToServer(_shared_config__WEBPACK_IMPORTED_MODULE_0__.EVENT_NAMES.selectHero, { heroId });
}
function interactPickup(pickupId) {
    GameEvents.SendCustomGameEventToServer(_shared_config__WEBPACK_IMPORTED_MODULE_0__.EVENT_NAMES.interactPickup, { pickupId });
}
function useTeleport(sourceId) {
    GameEvents.SendCustomGameEventToServer(_shared_config__WEBPACK_IMPORTED_MODULE_0__.EVENT_NAMES.teleportUsed, { sourceId });
}
...
/* harmony import */ var _panorama_utils_hero_data__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @panorama/utils/hero_data */ "./src/panorama/utils/hero_data.ts");
/* harmony import */ var _panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @panorama/utils/net */ "./src/panorama/utils/net.ts");





function useNetTableState(reader, initial) {
    const [value, setValue] = react__WEBPACK_IMPORTED_MODULE_0__.useState(initial);
...
function HeroSelectOverlay(props) {
    ...
    const isVisible = ((snapshot === null || snapshot === void 0 ? void 0 : snapshot.phase) === "warmup" || (snapshot === null || snapshot === void 0 ? void 0 : snapshot.phase) === "pregame") && !confirmed;
    if (!isVisible) {
        return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "HeroSelectOverlay", style: { visibility: "collapse" } });
    }
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "HeroSelectOverlay" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "HeroSelectPanel" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { id: "HeroSelectTitle", text: "\u9009\u62E9\u4F60\u7684\u5C04\u624B" }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { id: "HeroSelectSubtitle", text: "\u6BCF\u4F4D\u82F1\u96C4\u7684\u6295\u5C04\u624B\u611F\u5404\u4E0D\u76F8\u540C" }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "HeroGrid" }, _shared_types__WEBPACK_IMPORTED_MODULE_2__.HERO_IDS.map((heroId) => {
                const def = _panorama_utils_hero_data__WEBPACK_IMPORTED_MODULE_3__.HERO_DEFINITIONS[heroId];
                const isSelected = selectedHero === heroId;
                return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { key: heroId, className: `HeroCard ${isSelected ? "HeroCard--selected" : ""}`, onactivate: () => onSelect(heroId) },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "HeroCardName", text: def.displayNameCn }),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "HeroCardNameEn", text: def.displayName }),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "HeroCardDifficulty", text: `难度: ${DIFFICULTY_LABELS[def.difficulty]}`, style: { color: DIFFICULTY_COLORS[def.difficulty] } }),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "HeroCardDesc", text: def.description })));
            })),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(TextButton, { id: "HeroConfirmButton", className: selectedHero ? "" : "HeroConfirmButton--disabled", text: selectedHero ? "确认选择" : "请先选择英雄", onactivate: onConfirm }))));
}
function KillFeedEntry(props) {
    const { attackerName, victimName, heroName } = props;
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { className: "KillFeedEntry" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "KillFeedAttacker", text: attackerName }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "KillFeedAction", text: " \u51FB\u6740\u4E86 " }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "KillFeedVictim", text: victimName }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "KillFeedHero", text: ` [${heroName}]` })));
}
function App() {
    var _a, _b, _c, _d, _e, _f, _g;
    const playerId = (0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__.getLocalPlayerId)();
    const playerState = useNetTableState(() => (0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__.getPlayerState)(playerId), undefined);
    const snapshot = useNetTableState(() => (0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__.getMatchSnapshot)(), undefined);
    const [selectedHero, setSelectedHero] = react__WEBPACK_IMPORTED_MODULE_0__.useState(undefined);
    const [confirmed, setConfirmed] = react__WEBPACK_IMPORTED_MODULE_0__.useState(false);
    const [killFeed, setKillFeed] = react__WEBPACK_IMPORTED_MODULE_0__.useState([]);
    ...
    const handleConfirmHero = () => {
        if (!selectedHero)
            return;
        setConfirmed(true);
        (0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__.selectHero)(selectedHero);
    };
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        $.Msg("[A1 HUD] mount");
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        const listener = GameEvents.Subscribe("oss_projectile_fired", (event) => {
            ...
            const particleId = Particles.CreateParticle("particles/ui_mouseactions/range_finder_cone.vpcf", ParticleAttachment_t.PATTACH_WORLDORIGIN, undefined);
            Particles.SetParticleControl(particleId, 0, origin);
            Particles.SetParticleControl(particleId, 1, target);
    ...
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        let cancelled = false;
        const listener = GameEvents.Subscribe("oss_kill_feed", (event) => {
            if (cancelled)
                return;
            const attackerName = Players.GetPlayerName(event.attacker_id) || `Player ${event.attacker_id}`;
            const victimName = Players.GetPlayerName(event.victim_id) || `Player ${event.victim_id}`;
            const heroDef = _panorama_utils_hero_data__WEBPACK_IMPORTED_MODULE_3__.HERO_DEFINITIONS[event.hero_id];
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "HudShell" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(HeroSelectOverlay, { snapshot: snapshot, onSelect: handleSelectHero, selectedHero: selectedHero, confirmed: confirmed, onConfirm: handleConfirmHero }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "KillFeed" }, killFeed.map((entry, index) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement(KillFeedEntry, { key: index, attackerName: entry.attackerName, victimName: entry.victimName, heroName: entry.heroName })))),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "TopBar" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "HudTitle", text: "\u4E00\u51FB\u5FC5\u6740" }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "HudTimer", text: `${Math.ceil((_a = snapshot === null || snapshot === void 0 ? void 0 : snapshot.timeRemaining) !== null && _a !== void 0 ? _a : 0)}s` }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "HudMode", text: (snapshot === null || snapshot === void 0 ? void 0 : snapshot.mode) === "ffa" ? "自由混战" : "组队模式" })),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "StatusCard" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "CardHeading", text: "\u6218\u6597\u72B6\u6001" }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `英雄: ${(playerState === null || playerState === void 0 ? void 0 : playerState.heroId) ? (_c = (_b = _panorama_utils_hero_data__WEBPACK_IMPORTED_MODULE_3__.HERO_DEFINITIONS[playerState.heroId]) === null || _b === void 0 ? void 0 : _b.displayNameCn) !== null && _c !== void 0 ? _c : playerState.heroId : "未选择"}` }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `祝福: ${(_d = playerState === null || playerState === void 0 ? void 0 : playerState.blessingId) !== null && _d !== void 0 ? _d : "none"}` }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `神符: ${(_e = playerState === null || playerState === void 0 ? void 0 : playerState.activeRuneId) !== null && _e !== void 0 ? _e : "none"}` }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `击杀 / 死亡: ${(_f = playerState === null || playerState === void 0 ? void 0 : playerState.kills) !== null && _f !== void 0 ? _f : 0} / ${(_g = playerState === null || playerState === void 0 ? void 0 : playerState.deaths) !== null && _g !== void 0 ? _g : 0}` }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `护盾: ${(playerState === null || playerState === void 0 ? void 0 : playerState.hasShield) ? "就绪" : "无"}` })),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "ActionCard" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "CardHeading", text: "\u64CD\u4F5C" }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { className: "ButtonRow" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(TextButton, { className: "ActionButton", onactivate: () => (0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__.interactPickup)("oss_blessing_shrine_shield"), text: "\u62A4\u76FE\u795D\u798F" }),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(TextButton, { className: "ActionButton", onactivate: () => (0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__.interactPickup)("oss_rune_spawn_haste"), text: "\u6781\u901F\u795E\u7B26" }),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(TextButton, { className: "ActionButton", onactivate: () => (0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_4__.useTeleport)("oss_teleport_1"), text: "\u4F20\u9001\u95E8" })))));
}
...
function mountHud() {
    ...
    (0,react_panorama__WEBPACK_IMPORTED_MODULE_1__.render)(react__WEBPACK_IMPORTED_MODULE_0__.createElement(App, null), root);
}
$.Schedule(0, mountHud);
