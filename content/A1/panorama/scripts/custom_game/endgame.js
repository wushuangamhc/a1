...
function useMatchSnapshot() {
    const [snapshot, setSnapshot] = react__WEBPACK_IMPORTED_MODULE_0__.useState();
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        ...
        const poll = () => {
            ...
            setSnapshot((0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_2__.getMatchSnapshot)());
            $.Schedule(0.2, poll);
        };
        $.Schedule(0.2, poll);
        return () => {
...
function EndgameApp() {
    ...
    if ((snapshot === null || snapshot === void 0 ? void 0 : snapshot.phase) !== "post_game") {
        return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "EndgameShell" });
    }
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "EndgameShell", className: "EndgameShell--visible" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "EndgameTitle", text: "Match Complete" }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `Mode: ${snapshot.mode}` }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `Winning Team: ${(_a = snapshot.winnerTeamId) !== null && _a !== void 0 ? _a : "TBD"}` }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { text: `Kill Target: ${snapshot.killTarget}` })));
}
...
function mountEndgame() {
    ...
    (0,react_panorama__WEBPACK_IMPORTED_MODULE_1__.render)(react__WEBPACK_IMPORTED_MODULE_0__.createElement(EndgameApp, null), root);
}
