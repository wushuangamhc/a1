...
/* harmony import */ var _panorama_utils_net__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @panorama/utils/net */ "./src/panorama/utils/net.ts");



function useScoreboard() {
    const [entries, setEntries] = react__WEBPACK_IMPORTED_MODULE_0__.useState([]);
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(() => {
        ...
        const poll = () => {
            ...
            setEntries((0,_panorama_utils_net__WEBPACK_IMPORTED_MODULE_2__.getScoreboardEntries)());
            $.Schedule(0.2, poll);
        };
        $.Schedule(0.2, poll);
        return () => {
...
function ScoreboardApp() {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { id: "ScoreboardShell" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "CardHeading", text: "Scoreboard" }),
        entries.map((entry) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement(Panel, { key: entry.playerId, className: "ScoreRow" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "ScoreName", text: entry.playerName }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "ScoreHero", text: entry.heroId }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "ScoreValue", text: `${entry.kills}` }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "ScoreValue", text: `${entry.deaths}` }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(Label, { className: "ScoreBlessing", text: entry.blessingId }))))));
}
...
function mountScoreboard() {
    ...
    (0,react_panorama__WEBPACK_IMPORTED_MODULE_1__.render)(react__WEBPACK_IMPORTED_MODULE_0__.createElement(ScoreboardApp, null), root);
}
