...
local ____state = require("game.state")
...
local ____pickup_system = require("game.systems.pickup_system")
local PickupSystem = ____pickup_system.PickupSystem
local ____combat_system = require("game.systems.combat_system")
local CombatSystem = ____combat_system.CombatSystem
local ____map_system = require("game.systems.map_system")
